...
async function tpmValidateFn() {
  ...
  const credentialPublicKeyJwkN = coerceToArrayBuffer(
    credentialPublicKeyJwk.n,
    "credentialPublicKeyJwk.n"
  );
  const credentialPublicKeyJwkExpBuf = coerceToArrayBuffer(
  ...
  const attCert = new Certificate(
    coerceToBase64(parsedAttCert, "parsedAttCert")
  );
  try {
